...
## Initialize 1st plot in upper left corner
  plot(mydf$Date3, mydf$Global_active_power, type = "l",xlab = ""
       ,ylab = "Global Active Power" )

  
## Initialize 2nd plot in upper right corner
  plot(mydf$Date3, mydf$Voltage, type = "l",xlab = "datetime"
       ,ylab = "Voltage" )


## Initialize 3rd plot in lower left corner
plot(mydf$Date3, mydf$Sub_metering_1, type = "l",xlab = "",ylab = "Energy sub metering")
...
## Initialize 4th plot in lower right corner
plot(mydf$Date3, mydf$Global_reactive_power, type = "l",xlab = "datetime"
...
print("plot4.png file is ready for viewing, it's in your wd")
